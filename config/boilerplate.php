...
return [
    ...
    */
    ...
    'ignored_bin'  => explode(',',env('IGNORED_BIN', '')),
    'plural_table_name_bin'  => explode(',',env('PLURAL_TABLE_NAME_BIN', '')),
    'singular_table_name_bin'  => explode(',',env('SINGULAR_TABLE_NAME_BIN', '')),
];
