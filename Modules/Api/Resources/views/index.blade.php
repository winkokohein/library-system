...
@section ('title', appName() . ' | ' . __('api::labels.backend.api.management'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('api::labels.backend.api.management') }} <small class="text-muted">{{ __('api::labels.backend.api.list') }}</small>
                </h4>
            </div><!--col-->
        ...
        <div class="row mt-4">
            <div class="col">
                <div class="table-responsive">
                    <table id="api-table" class="table table-condensed table-hover">
                        <thead>
                        <tr>
                            <th>{{ __('api::labels.backend.api.table.id') }}</th>
                            <th>{{ __('api::labels.backend.api.table.last_updated') }}</th>
