...
@section ('title', __('bookcategory::labels.backend.bookcategory.management') . ' | ' . __('bookcategory::labels.backend.bookcategory.create'))
...
@section('content')
{{ html()->form('POST', route('admin.bookcategory.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('bookcategory::labels.backend.bookcategory.create') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
